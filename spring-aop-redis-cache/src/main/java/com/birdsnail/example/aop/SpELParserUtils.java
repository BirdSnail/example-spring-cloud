...
public final class SpELParserUtils {
     ...
     * 解析spel表达式
     *
     * @param pjp            spring aop的连接点对象
     * @param spelExpression 表达式
     * @return 表达式的结果
     */
    public static String parse(ProceedingJoinPoint pjp, String spelExpression) {
        ...
        return getResult(context, spelExpression, String.class);
    }
